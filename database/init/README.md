...
docker volume rm headstart_postgres_data
...
docker exec -it headstart-postgres-1 psql -U postgres -d pend

# Run A Specific Script
docker exec -i headstart-postgres-1 psql -U postgres -d pend < database/init/01-init-database.sql
```
