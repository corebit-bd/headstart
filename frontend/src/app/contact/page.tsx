      ...
      <div className="max-w-3xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 font-body text-black-600">
            Have a question for our Academic or Advisory wing? Reach out below.
          </p>
        </div>

        {submitted ? (
          <div className="bg-success-50 border border-success-200 p-8 rounded-2xl text-center">
            <h2 className="font-heading text-2xl font-bold text-success-1000">
              Inquiry Received!
            </h2>
            <p className="mt-2 font-body text-success-900">
          ...
          <form
            ...
            className="bg-white p-8 rounded-3xl shadow-sm border border-brand-grey-1000 space-y-6"
          >
            <div>
              <label
                htmlFor="name"
                className="block font-heading text-sm font-medium text-black-700 mb-2"
              >
                Full Name
              </label>
              <input
              ...
              />
              {errors.name && (
                <p className="mt-1 text-xs text-error-1000 font-body">
                  {errors.name}
                </p>
              )}
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-brand-purple-1000 text-white font-heading font-bold py-4 rounded-lg hover:bg-brand-purple-900 transition-all shadow-md"
            >
              Send Inquiry
            </button>
          </form>
